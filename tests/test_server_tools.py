...
def test_selection_none_tool_exists():
    assert hasattr(srv, "gimp_selection_none")


def test_selection_fill_tool_exists():
    assert hasattr(srv, "gimp_selection_fill")


def test_selection_stroke_tool_exists():
    assert hasattr(srv, "gimp_selection_stroke")
